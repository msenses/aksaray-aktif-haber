		...
		<footer className="mt-16 border-t border-black/5 dark:border-white/10">
			<div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-10 grid gap-8 sm:grid-cols-2 lg:grid-cols-4">
				...
				<div className="text-sm">
					...
					<div className="flex gap-4 flex-wrap">
						<a href={(process.env.NEXT_PUBLIC_FACEBOOK_URL || "https://facebook.com/aksarayaktifhaber")} target="_blank" rel="noopener noreferrer" aria-label="Facebook" className="hover:underline underline-offset-4 flex items-center gap-2">
						...
						<a href={(process.env.NEXT_PUBLIC_TWITTER_URL || "https://twitter.com/aksarayaktifhaber")} target="_blank" rel="noopener noreferrer" aria-label="X" className="hover:underline underline-offset-4 flex items-center gap-2">
						...
						<a href={(process.env.NEXT_PUBLIC_INSTAGRAM_URL || "https://instagram.com/aksarayaktifhaber")} target="_blank" rel="noopener noreferrer" aria-label="Instagram" className="hover:underline underline-offset-4 flex items-center gap-2">
							<svg aria-hidden="true" focusable="false" viewBox="0 0 24 24" className="w-4 h-4" fill="none" stroke="currentColor">
