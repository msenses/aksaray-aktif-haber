		...
		<div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-10">
			...
			{q && items.length > 0 && (
				<div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
					{items.map((n) => (
						<NewsCard key={n.id} title={n.title} excerpt={n.summary || ""} category="Arama" date={n.published_at || new Date().toISOString()} slug={n.slug} imageSrc={n.cover_image_url || undefined} />
					))}
				</div>
			)}
